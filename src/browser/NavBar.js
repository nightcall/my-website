			...
			<div id='nav-bar'>
				<nav>
					<div>
						...
						<h3><a href='#about' onClick={scrollToDiv('about')}>{tr('navbar-about')}</a></h3>
						<h3><a href='#projects'onClick={scrollToDiv('projects')}>{tr('navbar-projects')}</a></h3>
						<h3><a href='#contact' onClick={scrollToDiv('contact')}>{tr('navbar-contact')}</a></h3>
					</div>
					<div>
